...
import (
	...
	"github.com/devsolux/clash-meta/adapter"
	"github.com/devsolux/clash-meta/adapter/outbound"
	"github.com/devsolux/clash-meta/adapter/outboundgroup"
	"github.com/devsolux/clash-meta/adapter/provider"
	N "github.com/devsolux/clash-meta/common/net"
	"github.com/devsolux/clash-meta/common/utils"
	"github.com/devsolux/clash-meta/component/auth"
	"github.com/devsolux/clash-meta/component/fakeip"
	"github.com/devsolux/clash-meta/component/geodata"
	"github.com/devsolux/clash-meta/component/geodata/router"
	P "github.com/devsolux/clash-meta/component/process"
	"github.com/devsolux/clash-meta/component/resolver"
	SNIFF "github.com/devsolux/clash-meta/component/sniffer"
	tlsC "github.com/devsolux/clash-meta/component/tls"
	"github.com/devsolux/clash-meta/component/trie"
	C "github.com/devsolux/clash-meta/constant"
	providerTypes "github.com/devsolux/clash-meta/constant/provider"
	snifferTypes "github.com/devsolux/clash-meta/constant/sniffer"
	"github.com/devsolux/clash-meta/dns"
	L "github.com/devsolux/clash-meta/listener"
	LC "github.com/devsolux/clash-meta/listener/config"
	"github.com/devsolux/clash-meta/log"
	R "github.com/devsolux/clash-meta/rules"
	RP "github.com/devsolux/clash-meta/rules/provider"
	T "github.com/devsolux/clash-meta/tunnel"
...
func UnmarshalRawConfig(buf []byte) (*RawConfig, error) {
	...
	rawCfg := &RawConfig{
		...
		GeoXUrl: GeoXUrl{
			Mmdb:    "https://github.com/devsolux/maxmind-geoip/releases/latest/download/geoip.metadb",
			GeoIp:   "https://github.com/devsolux/maxmind-geoip/releases/latest/download/geoip.dat",
			GeoSite: "https://github.com/devsolux/maxmind-geoip/releases/latest/download/geosite.dat",
		},
		ExternalUIURL: "https://github.com/devsolux/clash-meta-dashboard/releases/download/latest/dashboard.zip",
	}
