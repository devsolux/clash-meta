...
GOBUILD=CGO_ENABLED=0 go build -tags with_gvisor -trimpath -ldflags '-X "github.com/devsolux/clash-meta/constant.Version=$(VERSION)" \
		-X "github.com/devsolux/clash-meta/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
