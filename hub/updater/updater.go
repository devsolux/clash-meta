...
import (
	...
	clashHttp "github.com/devsolux/clash-meta/component/http"
...
var (
	...
	packageName    string
	backupDir      string
	backupExeName  string
	updateExeName  string

	baseURL       string = "https://github.com/devsolux/clash-meta/releases/download/Prerelease-Alpha/clash.meta"
	versionURL    string = "https://github.com/devsolux/clash-meta/releases/download/Prerelease-Alpha/version.txt"
	packageURL    string
