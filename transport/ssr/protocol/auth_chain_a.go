...
import (
	...
	"github.com/devsolux/clash-meta/common/pool"
	"github.com/devsolux/clash-meta/log"
	"github.com/devsolux/clash-meta/transport/shadowsocks/core"
	"github.com/devsolux/clash-meta/transport/ssr/tools"
)
...
func (a *authChainA) Decode(dst, src *bytes.Buffer) error {
	...
	for src.Len() > 4 {
		...
		// Temporary workaround for https://github.com/devsolux/clash-meta/issues/1352
